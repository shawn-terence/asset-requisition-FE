import AdminAllAssetsCard from "./AdminAllAssetsCard"
import api from "../../API/BaseURL"
import { addFilterBtns } from "../SharedComponents/SharedFunctions"

import { useEffect, useReducer, useState } from "react" 

const AdminAllAssetsReducer = (state,action) =>{
  switch(action.type){
    case"search":
...
const AdminAllAssets = () => {
  const [state,dispatch] = useReducer(AdminAllAssetsReducer,{
                                                                search:"",
                                                                category:[]
  })
  ...
  return (
      <div className="admin-all-assets">
          ...
          <header className="admin-all-assets-header |  dark:text-neutral-200">
            <div className="admin-total-assets-and-assets-search-wrapper | flex">
              ...
              <div className="admin-all-assets-search-bar-wrapper">
                ...
                className="admin-all-assets-search-bar" placeholder="Search by name or type" />
              </div>
            </div>
